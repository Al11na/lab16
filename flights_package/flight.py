...
def list_flights(flights):
    # Функция для вывода списка рейсов в виде таблицы
    headers = ["Номер рейса", "Пункт назначения", "Тип самолета"]
    data = [[flight['flight_number'], flight['destination'], flight['plane_type']] for flight in flights]
